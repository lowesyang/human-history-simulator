...
export const REGION_NAME_MAP: Record<string, string[]> = {
  ...
  scythian_confederations_500bce: ["Scythians"],
  ...
  southeast_asia_asean_mainland_maritime: ["Thailand", "Vietnam", "Malaysia", "Indonesia", "Philippines", "Cambodia", "Laos", "Burma"],
  ...
  lakhmids_476: ["Sasanian dependencies"],
  ...
  bantu_east_african_polities: ["Bantou"],
  bantu_east_africa_220: ["Bantou"],
  ...
  // --- Rome ---
  etruscan_chiefdoms: ["Etrurians", "Rome"],
  ...
  carthage_800bce: ["Carthaginian Empire"],
  ...
  saxons_476: ["Saxons"],
  sub_roman_britain_476: ["Celtic kingdoms"],
  picts_476: ["Picts"],
  scotti_dalriada_476: ["Scots"],
  ...
  maya_preclassic_chiefdoms: ["Maya chiefdoms and states"],
  ...
  zapotec_monte_alban_500bce: ["Monte Albán"],
  ...
  andean_regional_states: ["Andean states and chiefdoms"],
  ...
  west_mexico_chiefdoms_221_bce: ["Mesoamerican city-states and chiefdoms"],
  ...
  magyars_750: ["Magyars"],
  simhala_750: ["Simhala"],
  slavonic_tribes_750: ["Slavonic tribes"],
  champa_750: ["Champa"],
